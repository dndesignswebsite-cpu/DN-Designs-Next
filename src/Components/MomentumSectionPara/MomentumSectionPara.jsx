...
const MomentumSectionPara = ({
  ...
  useEffect(() => {
    ...
    const initAnimation = () => {
        ...
        gsap.fromTo(
          ...
          },
          {
            ...
            scrollTrigger: {
              ...
              /*
               * The animation itself does not need
               * to be recalculated on every refresh.
               */
       ...
       *
       * Multiple MomentumSectionPara components
       * should NOT individually refresh the entire page.
       */
    };

    /*
     * Wait for fonts because font loading can change
     * text dimensions and line wrapping.
     */
    const fontsReady = document.fonts
      ? document.fonts.ready
      : Promise.resolve();
