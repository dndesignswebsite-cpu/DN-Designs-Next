     ...
     <section className='form-section'>
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-sm-12 col-md-12 col-lg-6 left-strip-col map">
            <div className="left-strip-col-div">
          ...
          <div className="col-12 col-sm-12 col-md-12 col-lg-6 form-col">
          <div className="form-col-div">
          <h2 className="form-col-div-head">Fill Out The Form Below</h2>
          <p className="form-col-div-para">No long briefs. No perfect answers required. Just give us a glimpse of what you’re working on, and let’s start there.</p>
