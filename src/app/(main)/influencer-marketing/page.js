...
// ends here
 ...
 async function page() {
  ...
  const leftFaqs = [
    {
      question: "What do you mean by influencer marketing and how can it help grow my business?",
      answer:
    ...
    {
      question: "Can you mention the different types of content that an influencer can create to promote my brand?",
      answer:
     ...
     {
      question: "What is the purpose of an influencer marketing agency and why do I need one for my business?",
      answer:
     ...
     {
      question: "How does DN Designs, as an influencer marketing agency, decide the best influencers and platforms for my business?",
      answer:
     ...
     {
      question: "Do you consult brands while deciding on influencers to work with?",
      answer:
  ...
  const rightFaqs = [
    {
      question: "How much time do you need to launch an influencer marketing campaign?",
      answer: "Broadly speaking, an influencer marketing agency takes anywhere between 15 days to one month to launch a campaign. However, depending on the requirements of the campaign, it may take a little more time. These requirements could include the time needed to create high-quality or challenging content. ",
    },
    {
      question: "What should be the duration of a particular influencer marketing campaign?",
      answer: "There isn’t one specific period. The duration of a campaign depends on the goals. For example, a month-long campaign is sufficient to attain short-term objectives like a particular event promotion. In contrast, for a bigger goal, like a product launch and awareness, the campaign needs to run for around 2-3 months.",
    },

     {
      question: "How do influencer marketing agencies measure the success of a particular campaign? Do we receive a report also?",
      answer: "The success of any campaign depends on the achievement of the goals set in the initial stage. For instance, if the goal was to increase brand visibility and awareness, agencies can measure metrics like impressions and clicks. On the other hand, if the goal was to generate leads, agencies can monitor lead conversion and ROI. We regularly share all campaign reports with you.",
    },

     {
      question: "Are campaigns restricted to one particular platform, or can they run on different platforms at once?",
      answer: "No, campaigns do not need to be restricted to a specific platform. It can simultaneously run on different platforms.",
    },

     {
      question: "How are influencers compensated, and who handles these negotiations?",
            ...
            <div className="col-12 col-md-12 col-lg-3">
              <div className="grow-your-bussiness-col-main">
                <div className="grow-your-bussiness-col-1">
                  ...
                  <p>
                   Influencer marketing has the power to boost your brand visibility and business profit.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-12 col-lg-3">
              <div className="grow-your-bussiness-col-main">
                <div className="grow-your-bussiness-col-3">
                  ...
                  <p>
                   Let our experts connect you with influencers who can drive real results for your business.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-md-6 we-are-the-leading-para">
              <p>
                With the rise of social media, a whole new set of stars has gained prominence - social media stars. These stars have a huge number of followers who not only interact with them but also trust them. Businesses collaborate with these stars or influencers to reach their target audience and promote their brand. 
              </p>
            </div>
            <div className="col-12 col-md-6 we-are-the-leading-para">
              <p>
                This is what influencer marketing is all about. What is important for brands, though, is to collaborate with the right influencer who can bring about the desired results for the business. With the right partnership, brands can achieve much more than simply raising brand awareness. Let’s explore its advantages in a little detail.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className=" top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                  Mega influencers are big celebrities (film & television personalities, sports persons & social media personalities) whose followers count run into millions. They are extremely popular and thus each of their posts
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Mega Influencers</h3>
                  <p>
                    Mega influencers are big celebrities (film & television personalities, sports persons & social media personalities) whose followers count run into millions. They are extremely popular and thus each of their posts draws likes and comments in large numbers. When they promote your brand, it gets instant recognition. Working with them requires significant investment.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                    Macro influencers can be your perfect choice if you are looking to increase your brand awareness, but at a slightly lower cost than that needed for mega influencers. These influencers have primarily
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Macro Influencers</h3>
                  <p>
                    Macro influencers can be your perfect choice if you are looking to increase your brand awareness, but at a slightly lower cost than that needed for mega influencers. These influencers have primarily gained fame through social media and have a substantial number of followers - between 1 to 10 lakhs - with a wide range of interests and engagement levels.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                    If you want to raise brand trust and generate leads, partnering with micro influencers is an ideal choice. They have followers up to 100K, and their key strength is in better engagement rates
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Micro Influencers</h3>
                  <p>
                    If you want to raise brand trust and generate leads, partnering with micro influencers is an ideal choice. They have followers up to 100K, and their key strength is in better engagement rates. Their authentic, relatable and niche-specific content helps them earn the trust of their audience. They can, thus, bring positive results for your brand.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className=" top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                    Nano influencers have around 10k followers only, and may seem a little less influential. However, this is far from true. Nano influencers share a far greater connection and trust with their audience
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Nano Influencers</h3>
                  <p>
                   Nano influencers have around 10k followers only, and may seem a little less influential. However, this is far from true. Nano influencers share a far greater connection and trust with their audience. Their followers are, therefore, some of the most engaged ones with higher chances of conversion. Moreover, being relatively less expensive, they are a more suitable option for smaller businesses.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                    Local influencers are what you need when you want to scale your business in a local area or community. These budget-friendly influencers have built their presence and authority within certain
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Local Influencers</h3>
                  <p>
                   Local influencers are what you need when you want to scale your business in a local area or community. These budget-friendly influencers have built their presence and authority within certain communities and areas, and can, therefore, significantly influence the opinions and choices of people there. Apart from online engagement, they interact with the audience in real-life events too.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                   Content creators are similar to influencers, and yet they are different. They create informative, educational and entertaining content for digital platforms and could be bloggers, vloggers, podcasters
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Content Creators</h3>
                  <p>
                    Content creators are similar to influencers, and yet they are different. They create informative, educational and entertaining content for digital platforms and could be bloggers, vloggers, podcasters, graphic designers, photographers or even gamers. They focus on creating quality content and building a personal brand. They are perfect for a long-term collaboration.
                  </p>
                </div>
              </div>
              <img
