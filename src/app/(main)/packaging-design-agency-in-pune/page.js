...
async function page() {
  ...
  const leftFaqs = [
    ...
    {
      question: "Why is DN Designs one of the top packaging design companies in Pune?",
      answer:
  ...
  const rightFaqs = [
    ...
    {
      question: "How long does it take for a packaging design agency to complete a project?",
      answer:
        ...
        <div className="container">
          <div className={`${styles["hero-rows"]} row`}>
            <div className={`${styles["left-hero"]} col`}>
              <h1>Packaging Design Agency in Pune: Designing Impressive Packaging For You
        ...
        <div className="container">
          ...
          <div className="row mt-5">
            <div className="col-12 col-md-12 col-lg-12 col-xl-6 city-content-col">
              <div className="content-box-city-page">
                <h2>What Makes Our Packaging Designs Special
</h2>
                <p>
                 We design our packages to be showstoppers. Just as a showstopper steals the show on the ramp, our packaging designs make heads turn and create a buzz. This is super important because, unless this happens, your products run the risk of getting lost on store shelves (both physical and online stores). We, as a packaging design agency in Pune, bring our creative best to ensure that your products make an impression and leave a strong recall value with your customers.
                </p>
                <TalkToUsCityPages />
              </div>
            </div>
          ...
          <div className="col-12 col-md-12 col-lg-12 col-xl-6 city-image-col">
            ...
            <div className="col-12 col-md-12 col-lg-12 col-xl-6 city-content-col">
              <div className="content-box-city-page">
                <h2>
                 How Do We Make Impactful Designs
</h2>
                <p>
              Great packaging designs don’t just happen on their own. They are a result of strategy, creativity and most importantly, plenty of hard work. As an agency, we do exactly that. We understand your product, research the market, study your consumer behaviour and analyse your competitors’ work to figure out the right design direction. Every single element of the packaging design is selected carefully to make a difference, be it the colour, the font or the images.
                </p>
                <TalkToUsCityPages />
              </div>
            </div>
          ...
          <div className="row mt-5">
            <div className="col-12 col-md-12 col-lg-12 col-xl-6 city-content-col">
              <div className="content-box-city-page">
                <h2>We Design For Present & Future
</h2>
                <p>
            Our packaging design services in Pune go beyond a single product design or designs for the present. Whether you have multiple products and variants currently, or are planning to expand in future, we are perfectly prepared to deliver exceptional results. Our designs ensure that each of your products has a distinctive identity, but still reflects a unified brand identity. Clarity, consistency and strong brand strength - that’s what we aspire to achieve for your present performance and future growth.
                </p>
                <TalkToUsCityPages />
              </div>
            </div>
