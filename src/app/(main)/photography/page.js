      ...
      <section className='photography-image'>
        <div className='container'>
            <div className='row photography-image-img'>
                <img src='https://dndesigns.co.in/wp-content/uploads/2019/02/Neha-Secretary-Look-2-scaled.jpg' className='img-fluid'/>
            </div>
        </div>
      </section>
    ...
    <div className='container'>
        <div className='row'>
            ...
            <div className='visual-stories-that-content'>
                ...
                <p>Commercial photography at DN Designs is tailored to elevate brand presence through clean, professional imagery. From corporate portraits to product showcases and promotional shoots, the focus is on delivering visuals that speak directly to target audiences. </p>
            </div>
            </div>
            <div className='col'>
                <img src='https://dndesigns.co.in/wp-content/uploads/2019/02/flat-lay-nazakat-1-1.jpg' className='img-fluid'></img>
            </div>
        </div>
    </div>
</section>
