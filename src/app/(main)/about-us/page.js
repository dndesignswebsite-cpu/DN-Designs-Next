    ...
    <div>
            ...
            <div className="col-12 col-md-12 col-lg-6 projects-completed-div-main-col">
              <div className="row">
                <div className="col">
                  <div className="projects-completed-div">
                    <h3>
                      <AutoCounter target={300} speed={7} />+
                    </h3>
                ...
                <div className="col">
                  <div className="projects-completed-div projects-completed-div-box-sh">
                    <h3>
                      <AutoCounter target={150} speed={15} />+
                    </h3>
                    <h4>Happy Clients</h4>
              ...
              <div className="row">
                ...
                <div className="col">
                  <div className="projects-completed-div">
                    <h3>
                      <AutoCounter target={98} speed={20} />%
                    </h3>
      ...
      <section className="appr-pro">
        <div className="container">
            ...
            <div className="col-12 col-md-6 col-lg-3 mt-3">
              <div className="app-pro-div app-pro-div-gray">
                <div>
                  ...
                  <p>
                    We absolutely love it when something challenging comes our
                    way. It’s our chance to get ready for an exciting and
                    fun-filled branding journey ahead.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-3 mt-3">
              <div className=" app-pro-div app-pro-div-white">
                <div>
                  <h3>Innovation</h3>
                  <p>
                    ‘Let’s do something new, something out of the box’ - that’s
                    how we approach each project. Implementing innovative
                    designs and strategies is how we thrive and stay ahead.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row appr-pro-row-main">
            <div className="col-12 col-md-6 col-lg-3 mt-3"></div>
            ...
            <div className="col-12 col-md-6 col-lg-3 mt-3">
              <div className="app-pro-div app-pro-div-gray">
                <div>
                  ...
                  <p>
                    Together, we win. We firmly believe that it is the
                    collaborative effort of all our teams that ultimately makes
                    us winners. And, isn’t it always more fun to work together?
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-3 mt-3">
              <div className=" app-pro-div app-pro-div-white">
                <div>
                  ...
                  <p>
                    We don’t simply wish to work; we want to make a difference.
                    We want to make your brand the best in the industry -
                    something that even the competitors admire.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-3 mt-3">
              <div className=" app-pro-div app-pro-div-gray">
                <div>
                  ...
                  <p>
                    This is our ultimate goal - to see our clients happy with
                    our work. We love to see them succeed in the market. We
                    consider their happiness to be our biggest achievement.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row text-center">
            <div className="dedicated-team-hedg">
              <h2>
                We have got a dedicated team to
                <span className="dedicated-team-hedg-span">
                  {" "}
                  support you and your vision
                </span>
              </h2>
            </div>
            <img
            ...
            <div className="col-12 col-md-12 col-lg-9 points-about-right">
              <div className="points-about row">
                ...
                <div className="points-about-para col-12 col-md-12 col-lg-4">
                  <p>
                    Brand identity is a necessity. Without it, customers may
                    never get an idea about who you are and what your product is
                    all about. Identity includes the visual appearance of your
                    brand, its voice, story and messaging - essentially
                    everything that helps shape customers’ perception.
                  </p>
                </div>
                <div className="points-about-para col-12 col-md-12 col-lg-3">
                  <p>
                    Creating an identity is a difficult, complex and
                    time-consuming process. We do realise this, and that is
                    exactly why we are here. We are your partner in building a
                    solid brand identity - one that is visually stunning,
                    resonates with your target audience and boosts sales and
                    eventually profits.
                  </p>
                </div>
              </div>
              ...
              <div className="points-about row points-about-Comm">
                ...
                <div className="points-about-para col-12 col-md-12 col-lg-4">
                  <p>
                    Customers need to be aware of your product to buy it. If
                    they have no clue about the existence of your product, there
                    is no way it can succeed. For this reason, strategic
                    communication is important. It ensures that your product is
                    well-presented before your target audience, wherever they
                    might interact with it.
                  </p>
                </div>
                <div className="points-about-para col-12 col-md-12 col-lg-3">
                  <p>
                    If this feels like a slightly complicated task to do on your
                    own, don’t worry. We are right here! Our team of
                    communication experts excel in creating strategies that
                    effectively establish and promote your brand in the market.
              ...
              <div className="points-about row">
                ...
                <div className="points-about-para col-12 col-md-12 col-lg-4">
                  <p>
                    Perhaps you want to share informative content with your
                    audience, or maybe you want to sell your products online.
                    Whichever your goal may be, what you need here is a website.
                    A website where your customers can find everything - details
                    about your company and ways to purchase your goods. However,
                    just any website doesn’t work in a competitive landscape.
                  </p>
                </div>
                <div className="points-about-para col-12 col-md-12 col-lg-3">
                  <p>
                    It should be aesthetically appealing and easy to explore.
                    Visitors should conveniently find what they are looking for
                    and complete the tasks they have in mind. And this is
                    exactly what we strive to do. Our web designers create and
                    develop search-engine-friendly as well as user-friendly
