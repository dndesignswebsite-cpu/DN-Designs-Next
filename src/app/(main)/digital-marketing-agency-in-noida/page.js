...
export const metadata = {
  title: "Digital Marketing Agency In Noida – DN Designs",
  description: "High-quality animation services for your brand, including 2D, 3D, and motion graphics.",
  
  authors: [{ name: "DN Designs Team", url: "https://dn-designs-next.vercel.app/digital-marketing-agency-in-noida" }],
...
function page() {
  ...
  const leftFaqs = [
    {
      question: "How do traditional marketing and digital marketing differ from each other? Which one is more cost-effective?",
      answer:
    ...
    {
      question: "What kind of services does a full-service digital marketing company in India provide?",
      answer:
    ...
    {
      question: "How is hiring an online marketing agency better than doing the work inhouse?",
      answer:
    ...
    {
      question: "I already have an internal online marketing team. Can you work in collaboration?",
      answer:
  ...
  const rightFaqs = [
    {
      question: "What are the things that I should do while choosing a digital marketing agency in India?",
      answer: "To begin with, you should first establish your business goals and set your budget and resources. Thereafter, you should look for various digital marketing agency options and check their credentials - expertise, experience, track record, work portfolio - and pricing model. Select an agency which aligns most with your business objectives and budget.",
    },
    {
      question: "How does online marketing help businesses reach their target audience?",
      answer: "In online marketing, experts use both organic and paid methods to reach the target customers. Search engine optimisation attracts organic traffic while paid advertising (on search engines, YouTube, Facebook & Instagram) attracts more intent-driven customers (ready to make a purchase). Then there are emails and social media campaigns that help reach target customers based on their location, demographics, interests, and browsing behaviour. ",
    },
...

    {
      ...
      answer: "There isn’t any fixed cost per se. It all depends on your project requirements and the services you want us to deliver.",
    },

    {
      question: "How much time does it take before we can see results from the digital marketing efforts?",
      answer: "Online marketing involves a wide range of sub-services and all these can take different time frames to show results. For instance, paid advertisement can yield results in a much shorter time frame than organic SEO efforts. To give you an idea, the former can begin to show results within a week, whereas the latter may take up anywhere between 3-6 months for concrete results to start coming in.",
    },

    {
      question: "How do you know that your online marketing efforts have succeeded? What are your measurement techniques?",
      answer: "As a digital marketing company in India, setting KPIs (key performance indicators) before we begin the actual implementation of strategies is important for us. These KPIs measure various business objectives like an increase in website traffic, lead generation, sales, social media engagement, brand mentions, etc.",
    },
  ];
  ...
  const cards = [
    {
      ...
      image:
        "https://dndesigns.co.in/wp-content/uploads/2025/06/3-1-1.jpg",
    },
    {
      id: 2,
      point: "02",
      ...
      image:
        "https://dndesigns.co.in/wp-content/uploads/2025/06/4-1-2.jpg",
    },
    {
      id: 3,
      point: "03",
      ...
      image:
        "https://dndesigns.co.in/wp-content/uploads/2025/06/2-1-1.jpg",
    },
    {
      id: 4,
      point: "04",
      ...
      image:
        "https://dndesigns.co.in/wp-content/uploads/2025/06/3-2-1.jpg",
    },
  ];
      ...
      <section className="we-are-the-leading">
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-md-6 we-are-the-leading-para">
              <p>
               Digital marketing encompasses a diverse set of practices and techniques, both paid and earned. SEO, SMO, email campaign, content marketing and digital ads are just a few of these. Through these, marketers take the product or service to potential customers, arouse their interest, build trust and ultimately convert them into buyers and brand advocates.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className=" top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                    Let the experts at our digital marketing agency in Noida design and develop a professional
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Website Design & Development</h3>
                  <p>
                    Let the experts at our digital marketing agency in Noida design and develop a professional, captivating, user-friendly and SEO-optimised website for your business.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                   Your website cannot deliver the desired outcomes without SEO. This organic and cost-effective service 
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Search Engine Optimisation</h3>
                  <p>
                   Your website cannot deliver the desired outcomes without SEO. This organic and cost-effective service is a must for increasing online visibility and traffic, boosting engagement and driving conversions.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                    We know that a significant percentage of your core audience is on social media. Therefore, through
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Social Media Marketing</h3>
                  <p>
                   We know that a significant percentage of your core audience is on social media. Therefore, through our digital media strategies, we unlock the full potential of these platforms for your business.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className=" top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                   We collaborate with online creators (from your industry) with a large number of loyal and
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Influencer Marketing</h3>
                  <p>
                    We collaborate with online creators (from your industry) with a large number of loyal and engaged followers to give your brand the boost it needs.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  <h3>Pay-per-Click</h3>
                  <p>
                    Let’s advertise your business on SERP, Google-affiliated websites and social platforms (YouTube, Instagram & Facebook). Reach the target
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Pay-per-Click</h3>
                  <p>
                    Let’s advertise your business on SERP, Google-affiliated websites and social platforms (YouTube, Instagram & Facebook). Reach the target audience, drive traffic, build your brand and increase sales.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                   Engage your audience with high-quality videos of your product & services. We help you create
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Digital Videos</h3>
                  <p>
                    Engage your audience with high-quality videos of your product & services. We help you create, optimise and share your videos on platforms like YouTube, Instagram and Facebook.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className=" top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                   Your target audience needs relevant and valuable content that solves their information needs and helps them proceed in their purchase
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Content Writing & Marketing</h3>
                  <p>
                   Your target audience needs relevant and valuable content that solves their information needs and helps them proceed in their purchase journey. As a digital marketing company in India, we provide just that.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                    Online reputation is critical, whether it is of a brand or a person. The team at our digital
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Online Reputation Management</h3>
                  <p>
                   Online reputation is critical, whether it is of a brand or a person. The team at our digital marketing agency in Noida ensure you have a positive online image.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                   Emails are powerful tools. Connect with potential customers, build loyalty and increase sales. As the best digital marketing agency in Delhi NCR
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Email Campaigns</h3>
                  <p>
                   Emails are powerful tools. Connect with potential customers, build loyalty and increase sales. As the best digital marketing agency in Delhi NCR, we craft email marketing campaigns that drive conversions.
                  </p>
                </div>
              </div>
              <img
