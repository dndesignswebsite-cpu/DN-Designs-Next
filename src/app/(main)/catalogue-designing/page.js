...
export const metadata = {
  ...
  authors: [{ name: "DN Designs Team", url: "https://dn-designs-next.vercel.app/catalouge-designing" }],
  
  alternates: { canonical: "https://dn-designs-next.vercel.app/catalouge-designing" },
  
  robots: { index: true, follow: true, nocache: true },
  
  openGraph: {
    title: "Catalouge Desiging – DN Designs",
    description: "High-quality animation services for your brand, including 2D, 3D, and motion graphics.",
