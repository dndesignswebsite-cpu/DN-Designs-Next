...
export const metadata = {
  title: "Packaging Design | DN Designs",
...
function page() {
  ...
  const cards = [
    { 
      ...
      image: "https://dndesigns.co.in/wp-content/uploads/2025/06/smart-adult-caucasi.jpg",
    },
    {
      id: 2,
      point: "02",
    ...
    },
    {
      ...
      image: "https://dndesigns.co.in/wp-content/uploads/2025/06/Untitled-1.jpg",
    },
    {
      id: 4,
      point: "04",
  ...
  const mobileCrads = [
                              {
      mobileImage: "https://dndesigns.co.in/wp-content/uploads/2025/06/jgkj.jpg",
    },
    {
  ...
  const leftFaqs = [
    ...
    {
      question: "How are your package designs unique or better than other label designing companies?",
      answer:
    ...
    {
      question: "I want to sell my product both in physical stores and on e-commerce platforms. Will your package design fit both spaces?",
      answer:
    ...
    {
      question: "My product has several variants. Can you design the package as per the specifications of each?",
      answer:
  ...
  const rightFaqs = [
    {
      ...
      answer: "For sure, we can do that for you. All you need to do on your end is to provide us with a high-resolution image of yours, and we will incorporate it into your package design.",
    },
    {
      question: "How many revisions could I get for my package design?",
      answer: "The count doesn’t matter so much to us. What matters, though, is your satisfaction with our work. Therefore, we provide unlimited revisions to ensure that the final packaging and label design is what you envisioned for your product.",
    },

     {
      question: "I am planning to launch my brand in another country. Can you help create a packaging design that appeals to the audience there?",
      answer: "Yes, we can help you create a design that is suitable for a particular country, or even a specific region within India. The key things that we take care of here are cultural sensitivities, language preferences and local regulatory norms.",
    },

     {
      question: "I want help with printing and production of the designs. Do you offer this service too?",
      answer: "As a branding and design company, we are primarily focussed on creating stunning package, pouch and label designs for your products. However, we can put you in touch with a few of our reliable printers who can help you with the matter.",
    },

     {
      question: "What services do you provide other than package designing?",
      answer: "We are a Noida-based branding and design agency, and our suite of services includes everything - from branding solutions to website design and communication strategy development. To put it broadly, we help your business establish its presence both online and offline.",
    },
  ];

  // form section content
  const FormHead = "Let’s Discuss Over a Cup of Coffee"
  const FormPara = "As a product packaging design agency, we have solid experience in creating compelling, meaningful and legally compliant designs for your product’s package, label or pouch. We strive to create a design that has a magnetic effect on your target audience. Our core objective is to enhance your brand’s awareness in the market and thereby increase sales. Sounds just like what you are looking for? Contact us ASAP.! We can’t wait to design a striking packaging and label design for you."
            ...
            <div className="col-12 col-md-6 px-2 port-main-div ">
              <div className="port-div">
                ...
                <div className="port-content">
                  ...
                  <p>
                   Nutraceutical brand NECTARPURE wanted to establish its FusionMax Whey Protein product as a niche lifestyle protein brand. We provided consultation services to them and created a premium label design to appeal to their target audience.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 px-2 port-main-div">
              <div className="port-div">
                ...
                <div className="port-content">
                  ...
                  <p>
                    With their energy drink, Green Horn aspired to appeal to its young audience, who frequent clubs in New Zealand. We created a can design for the brand which conveyed a sense of energy and fun, perfect for party-loving youth.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 px-2 port-main-div">
              <div className=" port-div">
                ...
                <div className="port-content">
                  ...
                  <p>The Bobalist, the popping boba drink bottle, is a fresh new product for the Indian market and has been developed to target a young audience. We helped in selecting a suitable bottle and designing a label that reflects fun and freshness.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 px-2 port-main-div">
              <div className=" port-div">
                ...
                <div className="port-content">
                  ...
                  <p>The makers are veterans of the spice industry and collaborated with us for their own brand. For over 20 of their variants, we created a packaging design that blended modern and traditional elements to appeal to the target audience.
                  </p>
                </div>
              </div>
            </div>
            ...
            <li className="card-create" id="card1-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                   We get the ball rolling with a briefing and interaction session. This is where we sit down to discuss your product, its USP and STP (segmentation, targetting and positioning). This helps us understand your product’s speciality (and its need in the market), decide its segment, define the customer base and plan the best market positioning for it. For us, your inputs at this stage are extremely crucial to better understand your product and vision, and set the goals.
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card2-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                    This is our research stage. Once we get a briefing from you, we set out to explore the market, the competitors and the audience. This is important for the simple reason that your product will ultimately be launched in the same market and compete with other brands in the same category. Your product packaging and label design need to stand out to maintain a competitive edge while fulfilling customers’ requirements and expectations.
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card3-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                   This is where we decide the KLD (key line dimension), colour palette, typography, fonts, visuals, and other aspects of designing. We also create and share reference boards and mood boards with you so that you get a comprehensive visual idea about the various existing creative packaging/label/pouch designs in the market and your product design’s appeal and impact in comparison. Your active participation and feedback are crucial in finalising the design concepts in this stage as well.
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card4-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                    The creative process continues as we now finally move towards actually designing your product packaging. We take care of every design element - be it your logo, label, or graphics - and address any issues that might jeopardise the effective completion of the process. In addition, we ensure to integrate information critical for legal compliance. The prototyping and review phase follows until we reach the final design.
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card5-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                    Congratulations! You now have your beautiful design ready. We share the final design files with you in AI, CDR, PDF format for printing purposes. As a packaging design company, it is a proud moment for us.
                  </p>
                </div>
              </div>
            </li>
      ...
      <section className="creating-your-brand-mobile">
        <div className="conatiner">
          <h2 className="text-center our-brand-heading-a-mobile">
            Crafting the First Impression
            <span className="every-pr"> A Glimpse of Our Packaging Design Process</span>
          </h2>
        ...
        <div className="container">
          <div className="row">
            <h2 className="text-center headg">
             Your Visual Guide Through Your<span className="every-pr"> Packaging Design Journey</span>
            </h2>
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className=" top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  ...
                  <p>
                   How does a packaging design agency convey its design plan research to clients? It’s given that words alone can never do justice to it. After all, design is a visual creative process, and you need to see it
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Reference Board</h3>
                  <p>
                   How does a packaging design agency convey its design plan research to clients? It’s given that words alone can never do justice to it. After all, design is a visual creative process, and you need to see it to get a feel of it. In comes the reference board, a perfect visual tool through which we share with you our inspiration, design references and style direction. It includes visuals of existing packaging, label and pouch designs in the market as well as structural or dieline inspirations.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  <h3>Mood Board</h3>
                  <p>
                   While the reference board draws on inspiration and design ideas from the market, the mood board is where we define the design ideas for your product. It includes colours, typography and visuals - all of which
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>Mood Board</h3>
                  <p>
                   While the reference board draws on inspiration and design ideas from the market, the mood board is where we define the design ideas for your product. It includes colours, typography and visuals - all of which convey a certain emotion suitable to your brand identity. It offers a better visual idea of the final design, even before the design process has begun. In addition, it serves as a guide to the entire design process that follows, ensuring that the process stays on track and the number of revisions is minimal.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-12 col-lg-4 px-2 top-cap-main-div">
              <div className="p-3 top-cap-div m-3">
                ...
                <div className="top-cap-btm">
                  <h3>3D Mockups</h3>
                  <p>
                    Your label design is ready, but you are still struggling to visualise how it will eventually look. Don’t worry, you are not alone. This is a pretty common issue, and we have just the perfect solution for you - 3D mockups. These
                  </p>
                </div>
                <div className="top-cap-back-content">
                  <h3>3D Mockups</h3>
                  <p>
                   Your label design is ready, but you are still struggling to visualise how it will eventually look. Don’t worry, you are not alone. This is a pretty common issue, and we have just the perfect solution for you - 3D mockups. These give you a more precise and practical visualisation of how your product will appear and feel in the real world. Even now, if something doesn’t feel right, modifications and refinements can be made before finalising the design. Super helpful and interesting, right?
                  </p>
                </div>
              </div>
              <img
