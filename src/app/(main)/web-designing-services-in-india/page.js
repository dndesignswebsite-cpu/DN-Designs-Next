...
function page() {
  ...
  // faqs content
   const leftFaqs = [
    {
      question: "What kind of services does a website design company like DN Designs offer? ",
      answer:
    ...
    {
      question: "Could you elaborate on the time and the cost associated with website design?",
      answer:
    ...
    },
    {
      ...
      {
      question: "Will I be informed about the progress of my website design while it is still being made?",
      answer:
      ...
      {
      question: "Can I expect DN Designs to build an e-commerce website for my business?",
      answer:
   ...
   const rightFaqs = [
    {
      question: "What about third-party tools and apps? Is integration with my website a possibility?",
      answer: "Yes, it is totally a possibility. If there is a need to integrate third-party tools and apps, we take care of that as well during our design and development process.",
    },

    {
      question: "Will my website work well on mobile phones?",
      answer: "Yes, we build mobile-friendly websites. Your customers can easily browse through and take necessary actions (like purchasing a product) on your website while using their mobile phones.",
    },
            ...
            <div className="col-12 col-md-6 px-2 brand-identity-main-div ">
              <div className="brand-identity-div">
                ...
                <div className="brand-identity-content">
                  ...
                  <p>
                   The Bobalist is a first-of-its-kind product in India. The brand collaborated with us to create an interactive E-Commerce website to appeal to its young and fun-loving audience. Our website design not only impressed the audience but also increased their sales.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 px-2 brand-identity-main-div ">
              <div className="brand-identity-div">
                ...
                <div className="brand-identity-content">
                  ...
                  <p>
                   Dubai-based company, Qualiteq, offers its services in the telecommunications and technology sectors. For them, we created a website that exuded a professional aura. In addition, we designed the website to highlight Qualiteq’s key services and areas of expertise.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 px-2 brand-identity-main-div ">
              <div className="brand-identity-div">
                ...
                <div className="brand-identity-content">
                  ...
                  <p>
                 Another first-of-its-kind product in India, Mr. Bomzy offers cocktail bombs to make your cocktails and parties more exciting. We created an E-commerce website with a playful vibe to attract its Gen Z audience and give them a good shopping experience. Lively visuals and videos further elevated the customer experience.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 px-2 brand-identity-main-div ">
              <div className="brand-identity-div">
                ...
                <div className="brand-identity-content">
                  ...
                  <p>
                    India’s number one food and beverage consultant, Foodsure, wanted a more professional-looking website which effectively showcased its work and connected with its audience. We designed an interactive website that fulfilled its requirements and helped it increase engagement with its current audience base.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 px-2 brand-identity-main-div ">
              <div className="brand-identity-div">
                ...
                <div className="brand-identity-content">
                  ...
                  <p>
                  The Parda, one of the first brands to introduce blackout curtains in India, already enjoyed a strong presence on e-commerce platforms. However, it approached us to create its own e-commerce website to expand its reach. We designed a premium-looking website that retained a traditional feel and provided an easy browsing, filtering and shopping experience to its customers.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 px-2 brand-identity-main-div ">
              <div className="brand-identity-div">
                ...
                <div className="brand-identity-content">
                  ...
                  <p>
                   As a nutraceutical brand, Let’s Supp aspired to win the trust of its customers through transparency. The founder wanted to establish that wellness isn’t complicated; it is simple and joyful. We designed an elegant & minimal website that highlighted its key information and messages clearly and made purchasing its supplements an effortless process.
                  </p>
                </div>
              </div>
            </div>
            ...
            <li className="card-create" id="card1-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                   We begin with research and planning. We sit down with our clients to understand them - their business, vision and goals. Additionally, we research to understand their target audience and market. Once we know their needs, we plan the website. Should it be E-Commerce or an informative website? What should be its structure, and what technologies should be used to build it? We plan out every detail at the outset.
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card2-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  <h2>UI/UX Design</h2>
                  <p>
                   In the next step, our expert website designers create the UI/UX of the website. Our focus is on creating a responsive website design that appears visually pleasing, gives a positive impression and provides a good user experience. To fulfil these goals, we design the layout of the website, its visual appearance, and its navigation structure.
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card3-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                   With the design ready, it is now time to develop content. And, by content, we do not mean just the written text; rather, we include graphics, illustrations, videos, and all other materials that form part of the website. All these, together, play a key role in the success of your website. Hence, we make them relevant and valuable for your audience.
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card4-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  ...
                  <p>
                   Both the UI/UX design and content development work are now complete; therefore, we proceed to the next stage in our process. Here, we develop the website and add content as well as additional features (contact forms, navigation menu, SEO tools) into it. By the end of this stage, a properly functioning website is ready. 
                  </p>
                </div>
              </div>
            </li>
            ...
            <li className="card-create" id="card5-create">
              <div className="card-body-create row">
                ...
                <div className="col-10">
                  <h2>Review & Launch</h2>
                  <p>
                   Once the website is ready, we test it to make sure that it works well on all devices. If there are mistakes, we correct them. When everything is perfect, we make the website live. Afterwards, another round of testing is carried out to address any new issues that might have emerged.
                  </p>
                </div>
              </div>
            </li>
            ...
            <div className="col-12 col-md-6 col-lg-4 px-2 characteristics-of-good-main-div">
              <div className=" characteristics-of-good-div m-3">
                ...
                <div className="characteristics-of-good-btm">
                  ...
                  <p>
                   Whether you are a new business aspiring to establish your online presence or a successful business just realising the 
                  </p>
                </div>
                <div className="characteristics-of-good-back-content">
                  <h3>New Website Development</h3>
                  <p>
                   Whether you are a new business aspiring to establish your online presence or a successful business just realising the importance of a strong digital presence, what you need is a website. And that too, a beautiful-looking website that effectively fulfils your objectives, be it building brand awareness or boosting sales. As a website design agency, we offer you just that – we build brand new websites for you. 
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-6 col-lg-4 px-2 characteristics-of-good-main-div">
              <div className=" characteristics-of-good-div m-3">
                ...
                <div className="characteristics-of-good-btm">
                  ...
                  <p>
                    Does your website appear dull and outdated, or does it not amply reflect your brand identity? Is the user experience 
                  </p>
                </div>
                <div className="characteristics-of-good-back-content">
                  <h3>Website Redesign</h3>
                  <p>
                   Does your website appear dull and outdated, or does it not amply reflect your brand identity? Is the user experience poor, or are there technical issues troubling you? Whatever the problem, you surely do not need to worry. Our design experts are here to redesign your website and make it more visually appealing, SEO-friendly and technically solid. 
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-6 col-lg-4 px-2 characteristics-of-good-main-div">
              <div className="p-3 characteristics-of-good-div m-3">
                ...
                <div className="characteristics-of-good-btm">
                  ...
                  <p>
                    Several reasons can compel you to shift your website to WordPress or Shopify. For example, you might want to make 
                  </p>
                </div>
                <div className="characteristics-of-good-back-content">
                  <h3>Migration To WordPress/Shopify</h3>
                  <p>
                   Several reasons can compel you to shift your website to WordPress or Shopify. For example, you might want to make your website more secure, responsive, SEO-friendly and easy to use. However, migrating a website is a bit of a technical task, best performed by experts. This is where we step in. We make sure that your website migration process is smooth and error-free.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-6 col-lg-4 px-2 characteristics-of-good-main-div">
              <div className=" characteristics-of-good-div m-3">
                ...
                <div className="characteristics-of-good-btm">
                  <h3>SEO Service</h3>
                  <p>
                  A well-made website with few visitors can be a little disappointing. However, this is how a website may end up
                  </p>
                </div>
                <div className="characteristics-of-good-back-content">
                  <h3>SEO Service</h3>
                  <p>
                    A well-made website with few visitors can be a little disappointing. However, this is how a website may end up without any SEO activities. SEO ensures that your website appears at the top of the SERP whenever users search for certain keywords. Our SEO experts are here to achieve precisely this ranking for your business. We aspire to increase traffic, conversions and profits for your business.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-6 col-lg-4 px-2 characteristics-of-good-main-div">
              <div className=" characteristics-of-good-div m-3">
                ...
                <div className="characteristics-of-good-btm">
                  ...
                  <p>
                    A website needs to be regularly updated, monitored and maintained. We are aware of this, and therefore, we do not
                  </p>
                </div>
                <div className="characteristics-of-good-back-content">
                  <h3>Ongoing Support</h3>
                  <p>
                   A website needs to be regularly updated, monitored and maintained. We are aware of this, and therefore, we do not immediately leave our website once we have designed, developed, and delivered it to our clients. We are there to solve any problem or complete work that may arise at a later stage and require our attention. Our web design experts provide ongoing support for a specific period of time for this purpose.
                  </p>
                </div>
              </div>
              <img
            ...
            <div className="col-12 col-md-6 col-lg-4 px-2 characteristics-of-good-main-div">
              <div className="p-3 characteristics-of-good-div m-3">
                ...
                <div className="characteristics-of-good-btm">
                  ...
                  <p>
                   You need to update your website continuously. For instance, you may want to promote a new product or a limited-period
                  </p>
                </div>
                <div className="characteristics-of-good-back-content">
                  <h3>Content Management System</h3>
                  <p>
                    You need to update your website continuously. For instance, you may want to promote a new product or a limited-period offer. There could also be an upcoming event about which you want to share information. While our user-friendly websites make it easy for you to do these yourself, we are also there to perform these tasks on your behalf if you want us to. We make sure that your website stays updated and relevant for your customers all the time.
                  </p>
                </div>
              </div>
              <img
  ...
  <div className='container'>
    ...
    <img src='https://dndesigns.co.in/wp-content/uploads/2025/04/web-banner-2048x800.jpg' className='img-fluid'/>
      ...
      <div className='col-12 col-md-6 make-your-brand-col'>
        <p>What makes a brand click? A good product aside, it is its power to connect with customers and win their trust that works in its favour. A website plays a huge role in this. A beautiful and easy-to-navigate website with plenty of relevant information helps customers connect with and trust a brand more.</p>
      </div>

      <div className='col-12 col-md-6 make-your-brand-col'>
        <p>At DN Designs, we excel in creating these websites. We build websites that are visually pleasing, responsive, SEO-optimised and full of valuable information. With our creative website designs, you can successfully reach your audience, build connections and trust, increase sales and make your brand click.</p>
      </div>
    </div>
  </div>
</section>
