...
<section className='designs-that-speak'>
        <div className="container py-5">
            <h2 className="text-center fw-bold packaging-heading mb-4 d-none d-lg-block d-md-block">
                Designs That Speak Your<br/>
            ...
            <img src="https://dndesigns.co.in/wp-content/uploads/2025/02/banner.jpg" alt="" className="img-fluid ui-img1"/>
            <img src="https://dndesigns.co.in/wp-content/uploads/2025/04/grin-care-2.jpg" alt="" className="img-fluid ui-img2"/>
            <img src="https://dndesigns.co.in/wp-content/uploads/2025/04/action-air.jpg" alt="" className="img-fluid ui-img3"/>
        </div>
</section>
   ...
   <div className="container py-5">
            <div className="row">
                <div className="col-12 col-lg-6 col-md-6 text-start">
                    ...
                    <p className="ui-description mt-5">Let’s understand this with an example. You visit a website. Now, analyse your entire experience browsing through it. Did you face any issues? Did you get the information you wanted, or could you complete the task you went in to do? If your entire navigation experience through the site was seamless, simple and helpful, then this particular site has a good UX design (user experience).
                    </p>
                    <p className="ui-description"> How about the look and feel of the website? Was the colour pleasing and the text readable? Were the various interactive design elements like buttons, menus and icons impressive and really easy to use? Did they add to your overall positive experience? If your response is yes, then the site has a good UI (user interface) design too.
                    </p>
                    </div>
                </div>
                <div className="col-12 col-lg-6 col-md-6">
                    <img src="https://dndesigns.co.in/wp-content/uploads/2025/06/ui-ux.png" alt="" className="img-fluid"/>
                </div>
            </div>
        </div>
...
{/* craft */}
        ...
        <div className="container">
            ...
            <div className="row g-4 row-1"> 
                <div className="col-12 col-lg-5 col-md-12 d-flex">
                    <div className="landing-row p-5 rounded-4 text-start">
                        <h2 className="craft-heading">Landing <br/>PAGE</h2>
            ...
            <div className="row g-4 mt-5 row-2"> 
                <div className="col-12 col-lg-5 col-md-12 d-flex">
                    <div className="landing-row p-5 rounded-4 text-start">
                        <h2 className="craft-heading">MULTIPAGE  <br/>WEBSITE</h2>
                        <p className="craft-para mt-5">
            ...
            <div className="row g-4 mt-5 row-3"> 
                <div className="col-12 col-lg-5 col-md-12 d-flex">
                    <div className="landing-row p-5 rounded-4 text-start">
                        <h2 className="craft-heading">ONLINE  <br/>STORE</h2>
                        <p className="craft-para mt-5">
            ...
            <div className="row g-4 mt-5 row-4"> 
                <div className="col-12 col-lg-5 col-md-12 d-flex">
                    <div className="landing-row p-5 rounded-4 text-start">
                        <h2 className="craft-heading">DESIGN IN <br/>FIGMA</h2>
                        <p className="craft-para mt-5">
