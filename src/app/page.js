      ...
      <section className={`${styles['mobile-view-our-brand']}`}>
        <div className="container">
          ...
          <div className={`${styles['our-brand-mobile-all-div']}`}>
            <div className={`${styles['our-brand-mobile-div']} col-12 col-md-6`}>
              <img
                src="https://dndesigns.co.in/wp-content/uploads/2025/08/1.jpg"
                className="img-fluid"
              />
              <div className={`${styles['our-brand-mobile-div-content']}`}>
              <h3 className={`${styles['mobile-view-our-brand-h3']}`}>Rithm’s Enlite</h3>
              <div className={`${styles['our-brand-mobile-btn-up']}`}>
                <h4 className={`${styles['our-brand-mobile-btn']}`}>Brand Identity</h4>
                <h4 className={`${styles['our-brand-mobile-btn']}`}>Packaging</h4>
              </div>
              <div>
                <h4 className={`${styles['our-brand-mobile-btn']} ${styles[' our-brand-mobile-btn-bottom']} text-center`} >
